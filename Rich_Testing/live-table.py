''' A script illustrating dynamic table updating, using the "rich" 
    package. '''
...
def make_table( coin_list ):
    ...
    # Loop over the various coins and populate the table.
...
# Load the 'coin' data from the sample JSON file
